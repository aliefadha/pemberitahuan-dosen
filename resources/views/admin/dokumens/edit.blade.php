        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.dokumens.update', $dokumen) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ old('judul', $dokumen->judul) }}" required autofocus>
                    @error('judul')
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control @error('tanggal_deadline') is-invalid @enderror" id="tanggal_deadline" name="tanggal_deadline" value="{{ old('tanggal_deadline', $dokumen->tanggal_deadline->format('Y-m-d\TH:i')) }}" required>
